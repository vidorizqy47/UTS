...
public class DataUser extends AppCompatActivity {
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest("https://vrteknikinformatika.000webhostapp.com/todolist/User/get_all_user.php");
                return s;
            }
        }
    ...
    public void cancel (View view) {
        Intent intent = new Intent(DataUser.this, MenuUtama.class);
        startActivity(intent);
    }
}